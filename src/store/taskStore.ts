  ...
  persist(
    (set, get) => ({
      ...
      deleteBoard: (boardId) => set((state) => ({
        ...
        tasks: state.tasks.filter(task => !state.columns.some(col => col.id === task.columnId && col.boardId === boardId)),
      })),
      ...
      reorderColumns: (boardId, sourceIndex, destinationIndex) => set((state) => {
        ...
        return {
          columns: [
            ...state.columns.filter(col => col.boardId !== boardId),
            ...updatedColumns,
          ],
        };
      }),
      ...
      moveTask: (taskId, sourceColumnId, destinationColumnId, destinationIndex) => set((state) => {
      ...
      reorderTasks: (columnId, sourceIndex, destinationIndex) => set((state) => {
